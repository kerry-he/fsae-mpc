function [u_opt, x_opt, QP, exitflag, fval] = ltvmpc_dynamic_curvilinear(x0, x_ref, kappa, dt, x_lin, u_lin, QP)
...
%       x_opt - Optimised state trajectory
    ...
    u_lb = [repmat([-10; -0.4], N_steps, 1); 0; 0; 0; 0];
    u_ub = [repmat([10; 0.4], N_steps, 1); inf; inf; inf; inf];

    % Define cost weights
    Q = [5; 250; 2000; 0; 0; 0; 0];
    Q_terminal = Q * 10;
    R = [10, 10];
    R_soft = [1e8; 1e6; 1e6; 1e4];
