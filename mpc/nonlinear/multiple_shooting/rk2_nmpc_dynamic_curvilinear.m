...
%       info - Information about solved problem
    ...
    options.lb = [repmat([-inf; -inf; -inf; 0; -inf; -inf; -0.4; -10.0; -0.2], N_steps, 1); 0; 0]; % Lower bound on optimization variable
    options.ub = [repmat([inf; inf; inf; inf; inf; inf; 0.4; 10.0; 0.2], N_steps, 1); inf; inf]; % Upper bound on optimization variable
